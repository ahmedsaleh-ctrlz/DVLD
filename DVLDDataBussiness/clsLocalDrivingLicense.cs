...
using static DVLDBuisness.clsApplication;
...
namespace DVLDDataBussiness
{
...

    {
        ...
        public static bool IsThereAnyActiveLicense(string NationalNo, string className)
        {
            return clsLocalDrivingLicenseApplicationData.IsThereActiveSameLicense(NationalNo, className);
        }
